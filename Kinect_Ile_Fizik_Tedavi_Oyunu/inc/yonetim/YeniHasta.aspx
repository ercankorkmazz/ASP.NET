<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="YeniHasta.aspx.cs" Inherits="inc_yonetim_YeniHasta" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="row">
	    <div class="col-md-12 section-heading text-center" style="height:80px;">
	        <h2 class="to-animate">YENİ HASTA KAYDI</h2>
		</div>
	</div>
					...
					<tbody>
                        ...
                        <tr>
                            <td colspan="4" style="text-align:center;">
                                <asp:button id="kaydetBTN" runat="server" class="btn btn-primary" style="width:200px;" text="Kaydet" OnClick="kaydetBTN_Click" />
                            </td>
