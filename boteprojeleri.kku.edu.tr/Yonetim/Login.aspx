<%@ Page Language="C#" AutoEventWireup="true" CodeFile="Login.aspx.cs" Inherits="Yonetim_Default2" %>
...
<head runat="server">
    ...
    <title>Y&ouml;netim Paneli - Giriş Yap</title>
	  	...
	  	<div class="container">
		      ...
		      <div class="form-login">
		        ...
		        <div class="login-wrap">
                    <asp:TextBox ID="kadiTXT" class="form-control" placeholder="Kullanıcı Adı" runat="server"></asp:TextBox>
		            <br>
                    <asp:TextBox ID="sifreTXT" class="form-control" placeholder="Şifre" runat="server" TextMode="Password"></asp:TextBox>
		            <label class="checkbox">
		                <span class="pull-right">
		                    <a data-toggle="modal" href="~/Yonetim/Login.aspx#myModal" runat="server"> Şifrenizi mi unuttunuz?</a>
