...
public partial class Yonetim_inc_Hakkinda : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Page.IsPostBack == false)
        {
            ...
            bilgiGetir.verileriGetir("select hakkinda from sayfalar where id='1'");
    ...
    protected void kaydetBTN_Click(object sender, EventArgs e)
    {
        ...
        if (sayfaGuncelle.komutCalistir("update sayfalar set hakkinda='" + hakkindaTXT.InnerText + "' where id='1'") == "1")
        {
