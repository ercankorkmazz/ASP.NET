<%@ Page Title="" Language="C#" MasterPageFile="~/Yonetim/Yonetim.master" AutoEventWireup="true" CodeFile="Galeri.aspx.cs" Inherits="Yonetim_inc_Galeri" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <section id="main-content">
        <section class="wrapper site-min-height">
            <h3><i class="fa fa-angle-right"></i> Anasayfa / Slider</h3>
            <hr />
          	<div class="row mt">
          	    <div class="col-lg-12">
                    <table style="width:100%;" border="0">
                        ...
                        <tr>
                            <td align="right"><p>Önerilen (Genişlik: 370px, Yükseklik: 370px)</p></td>
                            <td>&nbsp;</td>
                        </tr>
                    </table>
          		    <hr />
		                    ...
		                    <div class="project">
		                        <div class="photo-wrapper" style="background:none;">
                                    <div class="ResimKutusu">
                                        <asp:Image ID="ResimKutusu" runat="server" ImageUrl="../../img/galeri/onizleme.jpg" CssClass="Resim" />
                                    </div>
		                        </div>
		                    </div>
		                </div>
