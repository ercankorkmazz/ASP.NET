...
public partial class G2_AGrubu : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int videoID = 2034;
        if (Session[Request.Url.Authority + "G2_AGrubuVideoID"] != null)
            videoID = Convert.ToInt32(Session[Request.Url.Authority + "G2_AGrubuVideoID"]);
    ...
    protected void rptvideolar_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rp.DataSource = yi.yorumCekOgrenciID(4075);
        rp.DataBind();
        rp.Dispose();
        ...
        vb.DataSource = videoButonlari.digerVideoListeleOgrID(4075);
        vb.DataBind();
        vb.Dispose();
    }
    protected void rptVideoGitButonlari_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Session[Request.Url.Authority + "G2_AGrubuVideoID"] = Convert.ToInt32(e.CommandArgument.ToString());
            akranvideogetir vi = new akranvideogetir();
            rptDigerVideolar.DataSource = vi.akranVideoListeleVideoID(Convert.ToInt32(Session[Request.Url.Authority + "G2_AGrubuVideoID"]));
            rptDigerVideolar.DataBind();
        }
    }
}