<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="G2_BGrubu.aspx.cs" Inherits="G2_BGrubu" %>
...
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    ...
    <div class="tablar">
        <div class="tabSol">
            <a href="../../inc/ogrenci/G2_AGrubu.aspx">
                <img src="../../images/adam.png" />
                <h4>Oyun 1</h4>
            </a>
        </div>
        <div class="tabOrta" style="background:#4ec9d4;">
            <a href="../../inc/ogrenci/G2_BGrubu.aspx">
                <img src="../../images/adam.png" />
                <h4>Oyun 2</h4>
            </a>
        </div>
        <div class="tabSag">
            <a href="../../inc/ogrenci/G2_CGrubu.aspx">
                <img src="../../images/adam.png" />
                <h4>Oyun 3</h4>
            </a>
        </div>
