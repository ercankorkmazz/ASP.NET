...
public partial class G2_BGrubu : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        int videoID = 2042;
        if (Session[Request.Url.Authority + "G2_BGrubuVideoID"] != null)
            videoID = Convert.ToInt32(Session[Request.Url.Authority + "G2_BGrubuVideoID"]);
    ...
    protected void rptvideolar_ItemDataBound(object sender, RepeaterItemEventArgs e)
    {
        ...
        rp.DataSource = yi.yorumCekOgrenciID(4076);
        rp.DataBind();
        rp.Dispose();
        ...
        vb.DataSource = videoButonlari.digerVideoListeleOgrID(4076);
        vb.DataBind();
        vb.Dispose();
    }
    protected void rptVideoGitButonlari_ItemCommand(object source, RepeaterCommandEventArgs e)
    {
        ...
        {
            Session[Request.Url.Authority + "G2_BGrubuVideoID"] = Convert.ToInt32(e.CommandArgument.ToString());
            akranvideogetir vi = new akranvideogetir();
            rptDigerVideolar.DataSource = vi.akranVideoListeleVideoID(Convert.ToInt32(Session[Request.Url.Authority + "G2_BGrubuVideoID"]));
            rptDigerVideolar.DataBind();
        }
    }
}