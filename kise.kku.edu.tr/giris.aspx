...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript">
            ...
            function kapat() {
                setTimeout(function(){ $.modal.close('.gg-fb'); }); // Popup burda kapanıyor
            }
    </script>
...
<body>
    ...
    <div class="gg-fb" style="display:none;">
    	<h2 class="fancybox_baslik">SANAL SPOR PLATFORMU BASINDA</h2>
    	<img src="images/fancybox_kapat.png" class="fancybox_kapat" onclick="kapat();" alt="Kapat">
        <div class="clearfix"></div>
        <iframe style="margin-top:7px;" src="https://www.youtube.com/embed/MxNM9ROmXLY?ecver=2" frameborder="0" allowfullscreen></iframe>
        <a href="Haberler.aspx">Haber ayrıntıları &raquo;</a>
	</div>
      ...
      <div class="container" style="padding-top:10px; width:100%;">
        <div class="navbar-header" style="margin:auto; padding-right:20px; width:100%;">
            <table border="0" style="margin:auto; width:1150px;">
                ...
                <tr>
                    <td class="logoBaslik" style="padding:0; text-align:center; width:500px;">SANAL SPOR EĞİTİMİ</td>
                </tr>
            </table>
        </div>
     </div>
