      ...
      <div class="AccordionPanel">
        ...
        <div class="AccordionPanelContent">
            ...
            <table border="0" style="width:100%;">
                <tr>
                    <td colspan="2">
                        <h4 style="padding-bottom:0;">Adı Soyadı Güncelle</h4>
                    </td>
                </tr>
                <tr>
                    <td style="width:700px;">
                        <table border="0" width="100%">
                            <tr>
                                <td>
                                    <asp:TextBox ID="adTXT" placeholder="Adınızı yazınız." runat="server" CssClass="ayarlarTXT"             Width="100%" Font-Bold="True" ValidationGroup="adSoyad"></asp:TextBox>
                                </td>
                                <td>
                                    <asp:TextBox ID="soyadTXT" placeholder="Soyadınızı yazınız." runat="server" CssClass="ayarlarTXT"       Width="100%" Font-Bold="True" ValidationGroup="adSoyad"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </td>
