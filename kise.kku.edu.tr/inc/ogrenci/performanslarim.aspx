<%@ Page Language="C#" EnableEventValidation="false" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="performanslarim.aspx.cs" Inherits="inc_ogrenci_ogrenmeAmacliVideolar" %>

<asp:Content ID="HeaderContent" runat="server" ContentPlaceHolderID="HeadContent">
</asp:Content>
<asp:Content ID="BodyContent" runat="server" ContentPlaceHolderID="MainContent">
    <h3 align="center" style="color:#09607f;">PERFORMANSLARIM</h3>
